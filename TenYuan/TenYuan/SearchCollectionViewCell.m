...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 创建现在价格
        self.NewPrice = [[UILabel alloc] initWithFrame:CGRectMake(5, self.ProductImgWX.height+self.Name.height, 55, 30)];
        self.NewPrice.textColor = [UIColor redColor];
        [self.contentView addSubview:self.NewPrice];
        // 创建原价
        self.OldPrice = [[UILabel alloc] initWithFrame:CGRectMake(60, self.ProductImgWX.height+self.Name.height, 70, 30)];
